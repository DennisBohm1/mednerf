...
if __name__ == '__main__':
    input_path = '~/mednerf/graf-main/data/Pancreas-99667'
    save_root_path = '~/mednerf/graf-main/data/Pancreas Results'
    ...
    preprocessing = True
    raw_input_file = '~/mednerf/graf-main/data/Pancreas Results/raw_file.mha'
